...
const ExpandedBox = ({ title, subTitle, colorTitle, initialBackgroundColor, expandedBackgroundColor, borderColor, isExpanded, onClick }) => {
    return (
        <Box
            onClick={onClick}
            sx={{
                ...
                p: '20px',
                backgroundColor: isExpanded ? expandedBackgroundColor : initialBackgroundColor,
        ...
        >
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
                <img src={isExpanded ? arrows_up : arrows_down} alt="Toggle Icon" />
