...
const branches = [
    ...
    { id: 5, name: 'Downtown Branch', description: 'Downtown Downtown Branch with a really long description that should be truncated.', imageSrc: image, isSelect: false },
    { id: 6, name: 'Mezzeh Branch', description: 'Mezzeh Mezzeh Branch', imageSrc: image, isSelect: false },
];
